...
# Wrap ninja with the strip shim
...
# TODO: Hotfix remove the Rust CMake file that conflicts with Rust Builds of KDE Software
dnf install -y qt6-qtwebengine-devel || true
rm -f /usr/lib64/cmake/Qt6/FindRust.cmake || true

# Run the Fedora variant of make-spaghetti
python ./make-spaghetti-fedora.py

# find-debuginfo is from rpm-build, available on Fedora natively
